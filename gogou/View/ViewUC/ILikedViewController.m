...
@interface ILikedViewController ()
...
- (void)delFav:(id)sender
{
    ...
    [SVProgressHUD show];
    NSURL *url = [[NSURL alloc] initWithString:USER_DEL_ATTENTION];
...
- (void)getData
{
    ...
    [SVProgressHUD show];
    NSURL *url = [[NSURL alloc] initWithString:USER_ALL_ATTENTION];
...
- (void)addSubView
{
    ...
    titleView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"title_i_liked"]];
    
    myTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 44, 320, VIEW_HEIGHT)];
    myTableView.dataSource = self;
    myTableView.delegate   = self;
    
    UIView *bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, VIEW_HEIGHT, 320, 49)];
