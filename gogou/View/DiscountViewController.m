...
-(void)refreshList
{
    ...
    [request setPostValue:nil           forKey:FILTER_MARKET_ID ];
    [request setPostValue:nil           forKey:FILTER_MANUFACTURER_ID];
    [request setPostValue:nil           forKey:FILTER_NAME];
    [request setPostValue:nil           forKey:FILTER_CATEGORY_ID];
